...
class CreateReturnPurchasesItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if(!Schema::hasTable('pos_return_purchases_items')){
        Schema::create('pos_return_purchases_items', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('due_quantity',$total=38,$places=2);
    ...
    {
        Schema::dropIfExists('pos_return_purchases_items');
    }
}
