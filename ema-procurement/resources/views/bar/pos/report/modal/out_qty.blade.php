  ...
  <?php $in=0; ?>
                           <table class="table datatable-basic table-striped">
                                       <thead>
                                        ...
                                        <tbody>
                                            <?php                   
                                               $account =App\Models\Bar\POS\PurchaseHistory::where('item_id', $key->id)->where('type', 'Debit Note')->whereIn('location',$loc_id)->whereBetween('purchase_date',[$start_date,$end_date])->orderBy('purchase_date','desc')->get();
                                                $iaccount =App\Models\Bar\POS\GoodIssueItem::where('item_id', $key->id)->where('status',1)->whereIn('start',$loc_id)->whereBetween('date',[$start_date,$end_date])->orderBy('date','desc')->get();
                        ...
                        <?php $in+=$i->quantity; ?>
                         ...
                         <?php
                              ...
                              $q = App\Models\Bar\POS\PurchaseHistory::where('item_id', $key->id)->where('type', 'Debit Note')->whereIn('location',$loc_id)->whereBetween('purchase_date',[$start_date,$end_date])->sum(\DB::raw('quantity'));
