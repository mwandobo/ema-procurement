        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="col-lg-10">
                    ...
                    <a class="btn btn-xs btn-primary" onclick="return confirm('Are you sure?')" href="{{ route('bar_purchase.edit', $purchases->id)}}" title=""> Edit </a>
                    ...
                    <a class="btn btn-xs btn-info" title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('bar_purchase.first_approval', $purchases->id)}}">First Approval</a>
                    @endif
                    @endcan
                  ...
                  @if(!empty($orders[0]) && $purchases->supplier_id != '')
                   ...
                   @endif
                    ...
                    <a class="btn btn-xs btn-success" href="{{ route('bar_purchase_pdfview',['download'=>'pdf','id'=>$purchases->id]) }}" title=""> Download PDF </a>
                                    ...
                                    <table class="table items invoice-items-preview" page-break-inside:="" auto;="">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                <td class=""><strong class="block">({{$item_name->item_code}}) - {{$item_name->name}}</strong></td>
                                                <td class="">{{ $row->due_quantity }} {{ $row->unit}}</td>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-12 col-md-12 col-lg-12">
                            <br>
                            <h5 class="mb0" style="text-align:center">SUPPLIER ORDERS</h5>
                            <div class="tab-content" id="myTab3Content">
                                <div class="tab-pane fade show active" id="about" role="tabpanel"
                                    aria-labelledby="home-tab2">
                                    <div class="row">
                                            ...
                                            <table class="table datatable-basic table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td> <a class="nav-link" href="{{ route('bar_order_pdfview',['download'=>'pdf','id'=>$row->id]) }}" title=""> Download Purchase Order </a></td>
                                                    </tr>
                                                    @endforeach
