                                                        ...
                                                        <tr class="line_items">
                                                            ...
                                                            <?php
                                                             $due=App\Models\Bar\POS\PurchaseHistory::where('purchase_id',$purchase_id)->where('item_id',$i->item_name)->where('type', 'Purchases')->sum('quantity');
                                                         $return=App\Models\Bar\POS\PurchaseHistory::where('purchase_id',$purchase_id)->where('item_id',$i->item_name)->where('type', 'Debit Note')->sum('quantity');
                                                          $qty=$due-$return;
                                                              ?>
...
console.log(id);
        $.ajax({
            url: '{{url("bar/purchases/findinvQty")}}',
            type: "GET",
            data: {
                id: id,
              item: item,
