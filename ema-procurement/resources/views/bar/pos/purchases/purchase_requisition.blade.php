                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <a class="nav-link" id="profile-tab2"
                                                        href="{{ route('bar_purchase.show',$row->id)}}" role="tab"
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        ...
                                                        <a class="list-icons-item text-primary" title="Edit"
                                                            ...
                                                            href="{{ route('bar_purchase.edit', $row->id)}}"><i
                                                                class="icon-pencil7"></i></a>&nbsp


                                                        {!! Form::open(['route' => ['bar_purchase.destroy',$row->id],
                                                        'method' => 'delete']) !!}
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="nav-link" title="Collect"
                                                                    ...
                                                                    href="{{ route('bar_purchase.first_approval', $row->id)}}">First
                                                                    Approval</a>
                                                                @endif
                                                                @endcan
                                                                ...
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to approve')"
                                                                    href="{{ route('bar_purchase.second_approval', $row->id)}}">Second
                                                                    Approval</a>
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to disapprove')"
                                                                    href="{{ route('bar_purchase.second_disapproval', $row->id)}}">Disapprove</a>
                                                                @endif
                                                                @endcan
                                                                ...
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to approve')"
                                                                    href="{{ route('bar_purchase.final_approval', $row->id)}}">Final
                                                                    Approval</a>
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to disapprove')"
                                                                    href="{{ route('bar_purchase.final_disapproval', $row->id)}}">Disapprove</a>
                                                                @endif
                                                                @endcan

                                                                <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('bar_purchase_pdfview',['download'=>'pdf','id'=>$row->id]) }}"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('bar_purchase.update', $id),
                                                'method' => 'PUT')) }}

                                                @else
                                                {{ Form::open(['route' => 'bar_purchase.store']) }}
                                                @method('POST')
                                                @endif
                                                            ...
                                                            <tr class="line_items">
                                                                <td><select name="item_name[]"
                                                                        ...
                                                                        as $n) <option value="{{ $n->id}}"
                                                                            ...
                                                                            selected @endif @endif >({{$n->item_code}}) - {{$n->name}}
                                                                        </option>
                                                                        @endforeach
                                                                    </select></td>
                                                                ...
                                                                <td style="display: none;"><select name="tax_rate[]"
                                                                        ...
                                                                        <option value="0" @if(isset($i))@if('0'==$i->
                                                                            tax_rate) selected @endif @endif>No tax
                                                                        </option>
                                                                        <option value="0.18"
                                                                            @if(isset($i))@if('0.18'==$i->
                                                                            tax_rate) selected @endif @endif>18%
                                                                        </option>
                                                                    </select></td>
    ...
    $(document).ready(function () {
        ...
        $('.add').on("click", function (e) {
            ...
            html +=
                ...
                count +
                '"><option value="">Select Item</option>@foreach($name as $n) <option value="{{ $n->id}}">({{ $n->item_code }}) - {{ $n->name }}</option>@endforeach</select></td>';
            html +=
