                                                ...
                                                <div class="col-sm-6">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <h5 class="mb-0">{{ __('restaurant.restaurant.information') }}</h5>
                                                        </div>
                                                        <div class="card-body">
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col">
                                                                    ...
                                                                    <input type="text" name="delivery_charge" class="form-control form-control-sm @error('delivery_charge') is-invalid @enderror" value="{{ old('delivery_charge', $restaurant->delivery_charge) }}">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-row">
                                                                <div class="form-group col">
                                                                    ...
                                                                    <input id="first_name" type="text" name="first_name" class="form-control form-control-sm @error('first_name') is-invalid @enderror" value="{{ old('first_name',  preg_split ("/\ /", $restaurant->user->name??"")[0]) }}">
                                                                    @error('first_name')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                                ...
                                                                <div class="form-group col">
                                                                    ...
                                                                    <span class="text-danger">*</span>
                                                                    <input id="last_name" type="text" name="last_name" class="form-control form-control-sm @error('last_name') is-invalid @enderror" value="{{ old('last_name', preg_split ("/\ /", $restaurant->user->name?? ",  ")[1]) }}">
                                                                    @error('last_name')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col">
                                                                    ...
                                                                    <input id="username" type="text" name="username" class="form-control form-control-sm @error('username') is-invalid @enderror" value="{{ old('username', $restaurant->user->email??"") }}">
                                                                    @error('username')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                            ...
                                                            <div class="form-row">
                                                                ...
                                                                <div class="form-group col">
                                                                    ...
                                                                    <input id="phone" type="text" name="phone" class="form-control form-control-sm @error('phone') is-invalid @enderror" value="{{ old('phone') }}">
                                                                    @error('phone')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col">
                                                                    ...
                                                                    <input type="number" name="deposit_amount" class="form-control form-control-sm @error('deposit_amount') is-invalid @enderror" value="{{ old('deposit_amount', $restaurant->user->deposit_amount??0) }}">
