    ...
    <div class="row" style="width:633px;heigth:470px;padding-left:185px;padding-top:35px; border-radius:7px; ">
        ...
        <div class="col-md-6"
            ...
            <div class="row" style="margin-top: -0.2em;">
                ...
                <h4 style="color:#487bf8;font-size:15px; font-weight: bolder;"><b>{{$member->full_name}}<br>
                <small>{{!empty($member->corporate_name)? "(".$member->corporate_name.")" :"" }}</small>
                        </b></h4>
        ...
        <div class="col-md-2" style="padding-left: 0px;background-color: {{$color}}; height: 295px;">
            <centre>
