...
<?php
                        ...
                        $cr1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->sum('credit');
                        $dr1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->sum('debit'); 

                        $cr = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('credit');
                        $dr = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
...
<?php
                        ...
                        $vat_in= \App\Models\Accounting\AccountCodes::where('account_name', 'VAT IN')->first();
                        $vat_out= \App\Models\Accounting\AccountCodes::where('account_name', 'VAT OUT')->first();

                        $cr_in = \App\Models\Accounting\JournalEntry::where('account_id', $vat_in->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('credit');
                        $dr_in = \App\Models\Accounting\JournalEntry::where('account_id', $vat_in->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('debit'); 

                        $cr_out = \App\Models\Accounting\JournalEntry::where('account_id',  $vat_out->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('credit');
                        $dr_out = \App\Models\Accounting\JournalEntry::where('account_id', $vat_out->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('debit');
...
<thead>
 ...
 <tbody>   
 <?php
                        $account = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
                            [$start_date, $second_date])->orderBy('date','asc')->get();
                            
                       $account1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
                            [$start_date, $second_date])->orderBy('date','asc')->get();
                        ?>  
 ...
 <?php
                        ...
                        $cr_modal = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('credit');
                        $dr_modal = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('debit');
                            
                         $cr_modal1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('credit');
                        $dr_modal1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->whereBetween('date',
                            [$start_date, $second_date])->sum('debit');
...
<thead>
 ...
 <?php
                         $vat_in = \App\Models\Accounting\AccountCodes::where('account_name', 'VAT IN')->first();
                        $account = \App\Models\Accounting\JournalEntry::where('account_id', $vat_in->account_id)->whereBetween('date',
                            [$start_date, $second_date])->orderBy('date','asc')->get();
...
<thead>
 ...
 <?php
                         $vat_out = \App\Models\Accounting\AccountCodes::where('account_name', 'VAT OUT')->first();
                        $account_out = \App\Models\Accounting\JournalEntry::where('account_id', $vat_out->account_id)->whereBetween('date',
                            [$start_date, $second_date])->orderBy('date','asc')->get();
