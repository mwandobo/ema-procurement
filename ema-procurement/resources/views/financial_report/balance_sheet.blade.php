...
<?php
                        ...
                        $cr_in = \App\Models\Accounting\JournalEntry::where('account_id', $vat_in->account_id)->where('date', '<=',
                            $start_date)->sum('credit');
                        $dr_in = \App\Models\Accounting\JournalEntry::where('account_id', $vat_in->account_id)->where('date', '<=',
                            $start_date)->sum('debit'); 

                        $cr_out = \App\Models\Accounting\JournalEntry::where('account_id',  $vat_out->account_id)->where('date', '<=',
                            $start_date)->sum('credit');
                        $dr_out = \App\Models\Accounting\JournalEntry::where('account_id', $vat_out->account_id)->where('date', '<=',
                            $start_date)->sum('debit');
...
​<td><a href="#view{{$account_code->account_id}}" data-toggle="modal"">{{$account_code->account_codes }}</a>
 ...
 <?php
                        ...
                        $dr1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('date', '<=',
                         ...
                         if($account_code->account_name == 'Retained income'){
...
<thead>
 ...
 <tbody>
                    <?php                   
                        $account = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('date', '<=',
 ...
 <?php
                        ...
                        $cr = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('date', '<=',
                            $start_date)->sum('credit');
                        $dr = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('date', '<=',
                            $start_date)->sum('debit');
...
foreach($group_modal->accountCodes as $account_code_modal){
                         ...
                         $cr_start = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->where('date', '<=',
                            $start_date)->sum('credit');
                        $dr_start  = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->where('date', '<=',
                            $start_date)->sum('debit');
...
foreach($group_modal->accountCodes as $account_code_modal){
                         ...
                         $cr_deff = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->where('date', '<=',
                            $start_date)->sum('credit');
                        $dr_deff  = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->where('date', '<=',
                            $start_date)->sum('debit');
...
<thead>
 ...
 <?php
                         $vat_in = \App\Models\Accounting\AccountCodes::where('account_name', 'VAT IN')->first();
                        $account = \App\Models\Accounting\JournalEntry::where('account_id', $vat_in->account_id)->where('date', '<=',
                            $start_date)->orderBy('date','asc')->get();
...
<thead>
 ...
 <?php
                         $vat_out = \App\Models\Accounting\AccountCodes::where('account_name', 'VAT OUT')->first();
                        $account_out = \App\Models\Accounting\JournalEntry::where('account_id', $vat_out->account_id)->where('date', '<=',
                            $start_date)->orderBy('date','asc')->get();
