                                                    ...
                                                    <table class="table table-striped" id="table-1">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeA even" role="row">
                                                                ...
                                                                <td>
                                                                    @php
                                                                    $tr=App\Models\Logistic\Truck::where('id',
                                                                    $row->source_truck)->get();
                                                                    @endphp
                                                                    @foreach($tr as $t)
                                                                    {{$t->truck_name}}
                                                                    @endforeach
                                                                ...
                                                                <td>
                                                                    ...
                                                                    $dr=App\Models\Logistic\Truck::where('id',
                                                                    $row->destination_truck)->get();
                                                                    @endphp
                                                                    @foreach($dr as $d)
                                                                    {{$d->truck_name}}
                                                                    @endforeach
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {!! Form::open(['route' =>
                                                                    ['good_reallocation.destroy',$row->id],
                                                                    'method' => 'delete']) !!}
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 ">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-lg-2 col-form-label">Source
                                                                        Truck</label>
                                                                    <div class="col-lg-4">
                                                                        <select class="form-control" name="source_truck"
                                                                    ...
                                                                    <label class="col-lg-2 col-form-label">Destination
                                                                        Truck</label>

                                                                    <div class="col-lg-4">
                                                                        <select class="form-control type_id"
                                                                            name="destination_truck" required id="">
