                                        ...
                                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link @if(!empty($id)) active show @endif"
                                                    ...
                                                    aria-controls="profile" aria-selected="false">New Purchase
                                                    Inventory</a>
                                            </li>
                                                            ...
                                                            <tr class="gradeA even" role="row">
                                                                ...
                                                                <td>
                                                                    <a class="nav-link" id="profile-tab2"
                                                                        href="{{ route('purchase_inventory.show',$row->id)}}"
                                                                        role="tab"
                                                                ...
                                                                <td>
                                                                    @php
                                                                    $loc=App\Models\Inventory\Location::where('id',
                                                                    $row->location)->get();
                                                                    @endphp
                                                                    @foreach($loc as $l)
                                                                    {{$l->name}}
                                                                ...
                                                                <td>
                                                                    ...
                                                                    {!! Form::open(['route' =>
                                                                    ['purchase_inventory.destroy',$row->id],
                                                                    'method' => 'delete']) !!}
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12 ">
                                                                ...
                                                                <input type="hidden" name="type"
                                                                    class="form-control name_list" value="{{$type}}" />
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label
                                                                        class="col-lg-2 col-form-label">Purchase Type</label>
                                                                    <div class="col-lg-4">
                                                                        <select class="form-control" name="purchase_type"
                                                                            required id="purchase_type">
                                                                ...
                                                                <div class="form-group row">
                                                                    <label class="col-lg-2 col-form-label">Purchase
                                                                        Date</label>
                                                                    <div class="col-lg-4">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label class="col-lg-2 col-form-label">Supplier
                                                                        Name</label>
                                                                    <div class="col-lg-4">
                                                                        <div class="input-group">
                                                                            ...
                                                                            <div class="input-group-append">
                                                                                <button class="btn btn-primary"
                                                                                    ...
                                                                                    value="" data-target="#appFormModal"
                                                                                    href="appFormModal"><i
                                                                ...
                                                                <div class="form-group row">
                                                                    <label
                                                                        class="col-lg-2 col-form-label">Currency</label>
                                                                    <div class="col-lg-4">
                                                                        @if(!empty($data->exchange_code))

                                                                        <select class="form-control"
                                                                            name="exchange_code" id="currency_code"
                                                                            required>
                                                                            <option value="{{ old('currency_code')}}"
                                                                                disabled selected>Choose option</option>
                                                                            @if(isset($currency))
                                                                            @foreach($currency as $row)
                                                                            <option @if(isset($data))
                                                                                {{$data->exchange_code == $row->code ? 'selected' : 'TZS' }}
                                                                    ...
                                                                    <label class="col-lg-2 col-form-label">Exchange
                                                                        Rate</label>
                                                                    <div class="col-lg-4">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered" id="cart">
                                                                        ...
                                                                        <tfoot>
                                                                            ...
                                                                            <tr class="line_items">
                                                                                <td colspan="4"></td>
                                                                                <td><span class="bold">Discount</span>:
                                                                                </td>
