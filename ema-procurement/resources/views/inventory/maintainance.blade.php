                                                    ...
                                                    <table class="table table-striped" id="table-1">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeA even" role="row">
                                                                ...
                                                                <td>
                                                                    @php
                                                                    $tr=App\Models\Facility\Facility::where('id',
                                                                    $row->facility)->get();
                                                                    @endphp
                                                                    @foreach($tr as $t)
                                                                    <a href="#view{{$row->facility}}"
                                                                        data-toggle="modal">{{$t->name}}</a>
                                                                    @endforeach
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <a class="btn btn-xs btn-outline-primary text-uppercase px-2 rounded"
                                                                        href="{{ route("maintainance.approve", $row->id)}}"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12 ">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <label class="col-lg-2 col-form-label">Facility</label>
                                                                    <div class="col-lg-4">
                                                                ...
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <select class="form-control" name="mechanical"
                                                                            required id="supplier_id">
                                                                ...
                                                                <div class="form-group row"><label
                                                                    ...
                                                                    <div class="col-lg-10">
                                                                        <textarea name="reason" class="form-control"
                                                                            required>@if(isset($data)){{ $data->reason }} @endif</textarea>
                                                                    </div>
                                                                </div>
...
@foreach( $maintain as $row)
<!-- Modal -->
<div class="modal inmodal " id="view{{$row->facility}}" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" style="text-align:center;">
                        @php
                        $tr=App\Models\Facility\Facility::where('id', $row->facility)->get();
                        @endphp
                        @foreach($tr as $t)
                        Maintainance History For {{$t->name}}
                        @endforeach
                        <h5>
                ...
                <div class="modal-body">
                    <div class="table-responsive">
                        ...
                        $history = \App\Models\Logistic\Maintainance::where('facility', $row->facility)->get();                                               
?>
