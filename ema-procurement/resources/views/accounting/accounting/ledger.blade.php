  ...
  <!-- /.box -->
    @if(!empty($start_date))
               ...
               <table class="table datatable-basic table-striped">
                    ...
                    $debit_total = 0;
                    ?>
                    @foreach(\App\Models\Accounting\ChartOfAccount::orderBy('gl_code','asc')->get() as $key)
                         <?php
                        $cr = 0;
                        $dr = 0;
                   
                        $cr = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->whereBetween('date',
                            [$start_date, $end_date])->sum('credit');
                        $dr = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->whereBetween('date',
                        ...
                        <tr>
                            <td>
 <a href="#view{{$key->id}}" data-toggle="modal" data-target="#view{{$key->id}}">{{ $key->gl_code }}</a>
</td>
                            <td>{{$key->name}}</td>
            ...
            <div class="panel-body table-responsive no-padding">
                ...
                <table class="table datatable-basic table-striped">
                    ...
                    @foreach(\App\Models\Accounting\ChartOfAccount::orderBy('gl_code','asc')->get() as $key)
                        ...
                        $cr = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->sum('credit');
                        $dr = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->sum('debit');
                        ...
                        <tr>
                            <td>
 <a href="#view{{$key->id}}" data-toggle="modal" data-target="#view{{$key->id}}">{{ $key->gl_code }}</a></td>
                            <td>{{$key->name}}</td>
...
foreach($group_modal->accountCodes as $account_code_modal){
                         ...
                         $cr_start = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->whereBetween('date',
                            [$start_date, $end_date])->sum('credit');
                        $dr_start  = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->whereBetween('date',
                            [$start_date, $end_date])->sum('debit');
...
foreach($group_modal->accountCodes as $account_code_modal){
                         ...
                         $cr_deff = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->whereBetween('date',
                            [$start_date, $end_date])->sum('credit');
                        $dr_deff  = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->whereBetween('date',
                            [$start_date, $end_date])->sum('debit');
...
<thead>
                    <tr>
                      ...
                      <th>Note</th>
                              ...
                              <tbody>   
 <?php
                        $account = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->whereBetween('date',
                            [$start_date, $end_date])->orderBy('date','asc')->get();
                            
                       $account1 = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->whereBetween('date',
                            [$start_date, $end_date])->orderBy('date','asc')->get();
                        ?>  
 ...
 <?php
                        ...
                        $cr_modal = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->whereBetween('date',
                            [$start_date, $end_date])->sum('credit');
                        $dr_modal = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->whereBetween('date',
                            [$start_date, $end_date])->sum('debit');
...
foreach($group_modal->accountCodes as $account_code_modal){
                         ...
                         $cr_start = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->sum('credit');
                        $dr_start  = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->sum('debit');
...
foreach($group_modal->accountCodes as $account_code_modal){
                         ...
                         $cr_deff = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->sum('credit');
                        $dr_deff  = \App\Models\Accounting\JournalEntry::where('account_id', $account_code_modal->account_id)->sum('debit');
...
<thead>
                    <tr>
                      ...
                      <th>Note</th>
                              ...
                              <tbody>   
 <?php
                        $account = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->orderBy('date','asc')->get();
                            
                       $account1 = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->orderBy('date','asc')->get();
                        ?>  
                 @foreach($account  as $a)
                                 <tr>
                        <td >{{$a->date }}</td>
 ...
 <?php
                        ...
                        $cr_modal = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->sum('credit');
                        $dr_modal = \App\Models\Accounting\JournalEntry::where('account_id', $key->id)->sum('debit');
