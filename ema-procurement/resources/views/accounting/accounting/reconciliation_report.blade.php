                                        ...
                                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2"
                                                    ...
                                                    aria-selected="true">Bank Reconciliation Report
                                                    List</a>
                                            </li>
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="sorting" tabindex="0"
                                                                    ...
                                                                    style="width: 188.1094px;">Notes</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @if(!@empty($data))
                                                            ...
                                                            <tr class="gradeA even" role="row">
                                                                ...
                                                                @if ($balance < 0) <td>Withdraw</td>
                                                                    ...
                                                                    <td>{{ $row->date }}</td>
                                                                    <td>{{ number_format(abs($row->debit -$row->credit),2) }}
                                                                    </td>
                                                                    <td>{{$row->notes }}</td>
                                                            </tr>
                                                            @endforeach
