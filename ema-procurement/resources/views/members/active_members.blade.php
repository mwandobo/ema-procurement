                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2" data-toggle="tab"
                                    href="#home" role="tab" aria-controls="home" aria-selected="true">Active Member
                                    List</a>
                            </li>
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                            <div class="tab-pane fade @if(empty($id)) active show @endif" id="home" role="tabpanel"
                                ...
                                <div class="table-responsive">
                                    <table class="table datatable-basic22 table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 250.484px;">Membership Class</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>{{!empty($row->membership_types)? $row->membership_types->name : ''
                                                    }} {{ isset($row->membership_types->class) ? '- '.
                                                    $row->membership_types->class : ''}}
                                                </td>
...
<!-- Include the necessary libraries as shown above -->
<script>
    $(document).ready(function() {
        $('.datatable-basic22').DataTable({
            dom: 'Bfrtip',
            buttons: [
                {
                    extend: 'copyHtml5',
