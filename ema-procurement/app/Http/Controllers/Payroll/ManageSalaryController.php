...
$designation_info = Designation::where('department_id',$departments_id)->get();
                    ...
                    $employee_info =User::where('department_id',$departments_id)->where('added_by',auth()->user()->added_by)->where('payroll','0')->where('disabled','0')->get();
                    $emp_info =User::where('department_id',$departments_id)->where('added_by',auth()->user()->added_by)->where('payroll','0')->where('disabled','0')->get();
                    if (!empty($emp_info)) {
  ...
  $dep_name=Department::where('id',$salary->department_id)->first();
      if(!empty($salary)){
       ...
       Toastr::success('Salary Details Saved Successfully','Success');
...
$designation_info = Designation::where('department_id',$departments_id)->get();
  ...
  $salary_grade_info ='';
    ...
    public function destroy($id)
    {
        ...
        Toastr::success('Salary Details Deleted Successfully','Success');
        return redirect(route('employee_salary_list'));
    }
