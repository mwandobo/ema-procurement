...
class ManageCardsController extends Controller
{
    ...
    public function index()
    {
     ...
     $cards = Cards::all()->where('picture','!=',null);
    ...
    Toastr::success('Cards Generated Successfully','Success');
    ...
    public function update(Request $request, $id)
    {
        ...
        $data['added_by'] = auth()->user()->id;
         ...
         Toastr::success('Cards Updated Successfully','Success');
        return redirect(route('manage_cards.index'));
    ...
    public function destroy($id)
    {
       ...
       Toastr::success('Cards Deleted Successfully','Success');
        return redirect(route('manage_cards.index'));
    }
