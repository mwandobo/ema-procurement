   ...
   public function show($id,Request $request)
    {
       ...
       $old=SupplierOrder::where('purchase_id',$id)->where('status','1')->first();
         ...
         switch ($request->type) {      
           case 'receive':
              return view('pos.purchases.item_details',compact('purchases','purchase_items','payments','id','name'));
                    break;
           case 'order':
             return view('pos.purchases.create_order',compact('purchases','purchase_items','payments','id','name','supplier','location'));
                    break;
           case 'supplier':
            return view('pos.purchases.confirm_supplier',compact('purchases','purchase_items','payments','id','name','supplier','location','orders','old'));
                    break;
         default:
            ...
            return view('pos.purchases.order_details',compact('purchases','purchase_items','payments','orders'));
           }
    ...
    public function edit($id)
    {
       ...
       return view('pos.purchases.purchase_requisition',compact('name','supplier','currency','location','data','id','items','type'));
    }
 ...
 public function purchase_requisition()
    {
        ...
        $location = Location::all();
        $type="";
       return view('pos.purchases.purchase_requisition',compact('name','supplier','currency','purchases','location','type'));
    }
 public function purchase_order()
    {
        ...
        $location = Location::all();
        $type="";
       return view('pos.purchases.purchase_order',compact('name','supplier','currency','purchases','location','type'));
    }
