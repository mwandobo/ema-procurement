...
class ProfomaInvoiceController extends Controller
{
    ...
    $location =  Location::where('added_by',auth()->user()->added_by)->get();;
        $region =Region::all();
         $edit="";
        $item_type="";
       return view('pharmacy.pos.sales.profoma_invoice',compact('name','client','currency','invoices','item_type','edit','s_name','bank_accounts','location','region'));
    }
    ...
    public function edit($id)
    {
      ...
      $location =  Location::where('added_by',auth()->user()->added_by)->get();;
       ...
       return view('pharmacy.pos.sales.profoma_invoice',compact('name','client','currency','data','id','items','item_type','edit','s_name','bank_accounts','location','region'));
    }
