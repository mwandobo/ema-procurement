...
<div class="navbar navbar-expand-lg navbar-dark bg-indigo navbar-static">
    ...
    <div class="d-flex justify-content-end align-items-center flex-1 flex-lg-0 order-1 order-lg-2">
        <ul class="navbar-nav flex-row">
            ...
            <li class="nav-item">
            <a href="<?php echo e(route('logout')); ?>"   class="navbar-nav-link navbar-nav-link-toggler"
...
<?php /**PATH /Users/user/Projects/emasuite/ema-procurement/resources/views/layout/main_navbar.blade.php ENDPATH**/ ?>