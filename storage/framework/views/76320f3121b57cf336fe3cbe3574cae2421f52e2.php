                                    ...
                                    <table class="table datatable-basic table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    <?php if($row->approval_1 == '' && $row->status == 0): ?>
                                                    <div class="badge badge-danger badge-shadow">Waiting For First
                                                        Approval</div>
                                                    <?php elseif($row->approval_1 != '' && $row->approval_2 == '' &&
                                                    $row->status == 0): ?>
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                        ...
                                                        <a class="list-icons-item text-primary" title="Edit"
                                                            ...
                                                            href="<?php echo e(route('bar_purchase.edit', $row->id)); ?>"><i
                                                                class="icon-pencil7"></i></a>&nbsp


                                                        <?php echo Form::open(['route' => ['bar_purchase.destroy',$row->id],
                                                        'method' => 'delete']); ?>

                                                        <?php echo e(Form::button('<i class="icon-trash"></i>', ['type' =>
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-first-approval')): ?>
                                                                <?php if($row->approval_1 == '' && $row->status == 0): ?>
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to approve')"
                                                                    href="<?php echo e(route('bar_purchase.first_approval', $row->id)); ?>">First
                                                                    Approval</a>
                                                                <?php endif; ?>
                                                                <?php endif; ?>

                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-second-approval')): ?>
                                                                <?php if($row->approval_1 != '' && $row->approval_2 == '' &&
                                                                $row->status == 0): ?>
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to approve')"
                                                                    href="<?php echo e(route('bar_purchase.second_approval', $row->id)); ?>">Second
                                                                    Approval</a>
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to disapprove')"
                                                                    href="<?php echo e(route('bar_purchase.second_disapproval', $row->id)); ?>">Disapprove</a>
                                                                <?php endif; ?>
                                                                <?php endif; ?>

                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-third-approval')): ?>
                                                                <?php if($row->approval_1 != '' && $row->approval_2 != '' &&
                                                                $row->approval_3 == ''): ?>
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to approve')"
                                                                    href="<?php echo e(route('bar_purchase.final_approval', $row->id)); ?>">Final
                                                                    Approval</a>
                                                                <a class="nav-link" title="Collect"
                                                                    onclick="return confirm('Are you sure? you want to disapprove')"
                                                                    href="<?php echo e(route('bar_purchase.final_disapproval', $row->id)); ?>">Disapprove</a>
                                                                <?php endif; ?>
                                                                <?php endif; ?>

                                                                <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('bar_purchase_pdfview',['download'=>'pdf','id'=>$row->id])); ?>"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('bar_purchase.update', $id),
                                                'method' => 'PUT'))); ?>
...
-->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input type="date" name="due_date"
                                                            placeholder="0 if does not exist"
                                                            value="<?php echo e(isset($data) ? $data->due_date : strftime(date('Y-m-d', strtotime("
                                                ...
                                                <input type="hidden" name="exchange_code"
                                                    value="<?php echo e(isset($data) ? $data->exchange_code : 'TZS'); ?>"
                                                    class="form-control" required>
                                                <input type="hidden" name="exchange_rate"
                                                    value="<?php echo e(isset($data) ? $data->exchange_rate : '1.00'); ?>"
                                                    class="form-control" required>
                                                <hr>
                                                        ...
                                                        <tfoot >
                                                            ...
                                                            <tr class="line_items">
                                                                <td><select name="item_name[]"
                                                                        ...
                                                                        <?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>"
                                                                            <?php if(isset($i)): ?><?php if($n->id == $i->item_name): ?>
                                                                            selected <?php endif; ?> <?php endif; ?> >(<?php echo e($n->item_code); ?>) - <?php echo e($n->name); ?>
                                                                ...
                                                                <td><input type="number" name="quantity[]"
                                                                        ...
                                                                        required /></td>
                                                                <td style="display: none;"><input type="text" name="price[]"
                                                                ...
                                                                <td style="display: none;"><select name="tax_rate[]"
                                                                        ...
                                                                        <option value="0" <?php if(isset($i)): ?><?php if('0'==$i->
                                                                            tax_rate): ?> selected <?php endif; ?> <?php endif; ?>>No tax
                                                                        </option>
                                                                        <option value="0.18"
                                                                            <?php if(isset($i)): ?><?php if('0.18'==$i->
                                                                            tax_rate): ?> selected <?php endif; ?> <?php endif; ?>>18%
                                                                        </option>
                                                                    </select></td>
                                                                ...
                                                                <input type="hidden" name="saved_items_id[]"
                                                                    ...
                                                                    value="<?php echo e(isset($i) ? $i->id : ''); ?>" required />
                                                                <td style="display: none;"><input type="text" name="total_cost[]"
                                                            ...
                                                            <tr class="line_items">
                                                                <td colspan="4"></td>
                                                                <td style="display: none;"><span class="bold">Sub Total </span>: </td>
                                                                <td style="display: none;"><input type="text" name="subtotal[]"
                                                            ...
                                                            <tr class="line_items">
                                                                <td colspan="4"></td>
                                                                <td style="display: none;"><span class="bold">Tax </span>: </td>
                                                                <td style="display: none;"><input type="text" name="tax[]"
                                                                        class="form-control item_total"
                                                            ...
                                                            <tr class="line_items">
                                                                <td colspan="4"></td>
                                                                <td style="display: none;"><span class="bold">Discount</span>: </td>
                                                                <td style="display: none;"><input type="text" name="discount[]"
                                                            ...
                                                            <tr class="line_items">
                                                                <td colspan="4"></td>
                                                                <?php if(!@empty($data->discount > 0)): ?>
                                                                <td style="display: none;"><span class="bold">Total</span>: </td>
                                    ...
                                    <div class="form-group row"><label class="col-lg-2 col-form-label">TIN</label>
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" name="TIN" id="TIN"
                                                value="<?php echo e(isset($data) ? $data->TIN : ''); ?>" class="form-control"
                                                required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row"><label class="col-lg-2 col-form-label">VAT</label>
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" name="VAT" id="VAT"
                                                value="<?php echo e(isset($data) ? $data->VAT : ''); ?>" class="form-control"
                                                required>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on('change', '.item_name', function () {
            ...
            $.ajax({
                url: '<?php echo e(url("bar/purchases/findInvPrice")); ?>',
                type: "GET",
                data: {
                    id: id
                },
    ...
    $(document).ready(function () {
        ...
        $('.add').on("click", function (e) {
            ...
            html +=
                ...
                count +
                '"><option value="">Select Item</option><?php $__currentLoopData = $name; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $n): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <option value="<?php echo e($n->id); ?>">(<?php echo e($n->item_code); ?>) - <?php echo e($n->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></select></td>';
            html +=
            ...
            html += '<td hidden><input type="text" name="price[]" class="form-control item_price' + count +
                '" placeholder ="price" required  value=""/></td>';
            html += '<td><input type="text" name="unit[]" class="form-control item_unit' + count +
                '" placeholder ="unit" readonly/></td>';
            html += '<td hidden ><select name="tax_rate[]" class="form-control m-b item_tax' + count +
            ...
            html += '<td hidden><input type="text" name="total_cost[]" class="form-control item_total' + count +
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Projects/emasuite/ema-procurement/resources/views/bar/pos/purchases/purchase_requisition.blade.php ENDPATH**/ ?>