<?php $__env->startSection('title'); ?> Bar Purchases <?php $__env->stopSection(); ?>
                                ...
                                <div class="table-responsive">
                                    <table class="table datatable-basic table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row" style="<?php echo e($row->disapprove_status == 1 ? 'background-color:#f8d7da;color:#721c24;' : ''); ?>">
                                                ...
                                                <td><?php echo e(number_format($row->due_amount,2)); ?> TZS</td>

                                                <td>
                                                    <?php
                                                    $loc=App\Models\Inventory\Location::where('id', $row->location)->get();
                                                    ?>
                                                    ...
                                                    <div class="form-inline">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <a class="nav-link" title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="<?php echo e(route('bar_purchase.second_approval', $row->id)); ?>">First Approval</a>
                                                                
                                                                <?php endif; ?>
                                                                <?php endif; ?>

                                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-third-approval')): ?>
                                                                <?php if($row->approval_1 != '' && $row->approval_2 != '' && $row->approval_3 == ''): ?>
                                                                <a class="nav-link" title="Collect" onclick="return confirm('Are you sure? you want to approve')" 
                                                                href="<?php echo e(route('bar_purchase.final_approval', $row->id)); ?>">Final Approval</a>
                                                                
                                                            
                                                                <a class="nav-link" title="Collect" onclick="return confirm('Are you sure? you want to disapprove')" 
                                                                ...
                                                                <a class="nav-link" id="profile-tab2" data-id="<?php echo e($row->id); ?>" data-type="receive" onclick="model(<?php echo e($row->id); ?>,'receive')"
                                                                    href="" data-toggle="modal" data-target="#appFormModal"
                                                                    role="tab"
                                                                    aria-selected="false">Good Receive</a>

                                                                <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('bar_purchase.issue',$row->id)); ?>"
                                                                    role="tab"
                                                                ...
                                                                <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('bar_purchase.pay',$row->id)); ?>"
                                                                    role="tab"
                                                                ...
                                                                <?php if( $row->good_receive == 1): ?>

                                                                <?php if( $row->purchase_costing != 1): ?>


                                                                <a class="nav-link" id="profile-tab2" data-id="<?php echo e($row->id); ?>" data-type="costing" onclick="model(<?php echo e($row->id); ?>,'costing')"
                                                                    href="" data-toggle="modal" data-target="#appFormModal"
                                                                    role="tab"
                                                                    aria-selected="false">Costing</a>
                                                                <?php endif; ?>


                                                                <a class="nav-link" id="profile-tab2"
                                                                    href="<?php echo e(route('bar_issue_pdfview',['download'=>'pdf','id'=>$row->id])); ?>"
                                                                    role="tab"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <select class="form-control m-b" name="exchange_code" id="currency_code" required>
                                                            ...
                                                            <option <?php if(isset($data)): ?> <?php echo e($data->exchange_code == $row->code ? 'selected' : 'TZS'); ?> <?php endif; ?> value="<?php echo e($row->code); ?>"><?php echo e($row->name); ?></option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php endif; ?>
                                                        </select>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Projects/emasuite/ema-procurement/resources/views/bar/pos/purchases/index.blade.php ENDPATH**/ ?>