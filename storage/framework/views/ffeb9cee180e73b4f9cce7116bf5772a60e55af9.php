                        ...
                        <ul class="nav nav-tabs" id="myTab2" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link <?php if(empty($id)): ?> active show <?php endif; ?>" id="home-tab2" data-toggle="tab"
                                    href="#home2" role="tab" aria-controls="home" aria-selected="true">Sales Quotations
                                     List</a>
                            </li>
                            <li class="nav-item">
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="badge badge-danger badge-shadow">Waiting For First Approval</div>
                                                         <?php elseif($row->approval_1 != '' && $row->approval_2 == '' && $row->status == 0): ?>
   ...
   <?php endif; ?>
                                                <div class="dropdown">
							                		<a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            <?php if($row->approval_1 == '' && $row->status == 0): ?>
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="<?php echo e(route('purchase.first_approval', $row->id)); ?>">First Approval</a>
                                                           <?php endif; ?>
                                                                <?php endif; ?>

                                                     <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage-second-approval')): ?>
                           <?php if($row->approval_1 != '' && $row->approval_2 == '' && $row->status == 0): ?>
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="<?php echo e(route('purchase.second_approval', $row->id)); ?>">Second Approval</a>
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to disapprove')" href="<?php echo e(route('purchase.second_disapproval', $row->id)); ?>">Disapprove</a>
                                         <?php endif; ?>
                                               <?php endif; ?>
                            ...
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="<?php echo e(route('purchase.final_approval', $row->id)); ?>">Final Approval</a>
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to disapprove')" href="<?php echo e(route('purchase.final_disapproval', $row->id)); ?>">Disapprove</a>
                          <?php endif; ?>
                                <?php endif; ?>

                       <a class="nav-link" id="profile-tab2" href="<?php echo e(route('purchase_pdfview',['download'=>'pdf','id'=>$row->id])); ?>"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                <?php if(isset($id)): ?>
                                                <?php echo e(Form::model($id, array('route' => array('purchase.update', $id), 'method' => 'PUT'))); ?>


                                                <?php else: ?>
                                                <?php echo e(Form::open(['route' => 'purchase.store'])); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Projects/emasuite/ema-procurement/resources/views/pos/sales/sale-quotations-index.blade.php ENDPATH**/ ?>