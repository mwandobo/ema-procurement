...
<div class="col-lg-3">
    <div class="card shadow-sm rounded-lg">
        <div class="card-body d-flex align-items-center">
            ...
            <div>
                <h3 class="font-weight-bold mb-0"><?php echo e(number_format($active_member + $exp_member)); ?></h3>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-restaurant')): ?>
<div class="col-lg-3">
    <div class="card shadow-sm rounded-lg">
        <div class="card-body d-flex align-items-center">
            ...
            <div>
                <h3 class="font-weight-bold mb-0"><?php echo e(number_format($invoice, 2)); ?> TSHS</h3>
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view-facilities_sales')): ?>
<div class="col-lg-3">
    <div class="card shadow-sm rounded-lg">
        <div class="card-body d-flex align-items-center">
            ...
            <div>
                <h3 class="font-weight-bold mb-0"><?php echo e(number_format($facility, 2)); ?> TSHS</h3>
...
<div class="col-lg-3">
    <div class="card shadow-sm rounded-lg">
        <div class="card-body d-flex align-items-center">
            ...
            <div>
                <h3 class="font-weight-bold mb-0"><?php echo e(number_format($deposit)); ?> </h3>
...
<div class="col-lg-3">
    <div class="card shadow-sm rounded-lg">
        <div class="card-body d-flex align-items-center">
            ...
            <div>
                <h3 class="font-weight-bold mb-0"><?php echo e(number_format($expense)); ?> </h3>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/user/Projects/emasuite/ema-procurement/resources/views/dashboard/dashboard1.blade.php ENDPATH**/ ?>