    ...
    <div class="navbar navbar-expand-lg navbar-dark bg-indigo navbar-static">
        <div class="navbar-brand ml-2 ml-lg-0">
            <a href="index.html" class="d-inline-block">
                ...
                <img src="<?php echo e(url('assets/img/logo.jpg')); ?>" alt="">  <?php echo e(!empty($settings->site_name) ? $settings->site_name: ''); ?>
...
<!--
   ...
   <li class="nav-item">
                ...
                <li class="nav-item">
                    <a  href="<?php echo e(url('members/register')); ?>" class="navbar-nav-link">
                 ...
                 <div class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="navbar-collapse collapse" id="navbar-footer">
                        <span class="navbar-text">
                            &copy; <?php echo date('Y'); ?> <a href="#"><?php echo e($settings->site_name); ?></a> by <a
...
<?php /**PATH /Users/user/Projects/emasuite/ema-procurement/resources/views/errors/minimal.blade.php ENDPATH**/ ?>