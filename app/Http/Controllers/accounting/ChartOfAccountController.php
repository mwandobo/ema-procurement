...
class ChartOfAccountController extends Controller
{
   ...
   $class_account = DB::table('gl_account_class')->select('gl_account_class.class_type')->where('added_by',auth()->user()->added_by)->groupBy('class_type')->get();
        return view('accounting.chart_of_account.data', compact('data','class_account'));
    }
    ...
    public function create()
    {
        ...
        return view('accounting.chart_of_account.create', compact(''));
    }
