                            ...
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link @if(empty($id)) active show @endif" id="home-tab2"
                                       data-toggle="tab"
                                       href="#home2" role="tab" aria-controls="home" aria-selected="true">Tax Invoices
                                        List</a>
                                </li>
                                <li class="nav-item">
                                        ...
                                        <table class="table datatable-basic table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 136.484px;">Quotation
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    ...
                                                    <tr class="gradeA even" role="row">
                                                        <td>
                                                            <a class="nav-link" id="profile-tab2"
                                                               href="{{ url('v2/sales/tax-invoices',$row->id)}}"
                                                               role="tab"
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-sm-12 ">
                                                    @if(isset($id))
                                                        {{ Form::model($id, ['url' => "/v2/sales/tax-invoices/{$id}", 'method' => 'PUT']) }}
                                                    @else
                                                        {{ Form::open(['url' => '/v2/sales/tax-invoices', 'method' => 'POST']) }}
                                                        @method('POST')
                                                    @endif
                                                    <div class="form-group row">
                                                        <label class="col-lg-2 col-form-label">Sale Order</label>
                                                        <div class="col-lg-4">
                                                            <select class="form-control m-b" name="sale_quotation_id"
                                                                    required
                                                                    id="sale_order_id">
                                                                <option value="">Select Sale Quotation</option>
                                                                @if(!empty($saleQuotations))
                                                                    @foreach($saleQuotations as $row)
                                                                        <option @if(isset($data))
                                                                                    {{  $data->sale_quotation_id === $row->id  ? 'selected' : ''}}
