                                                    ...
                                                    <div class="form-inline">
                                                        ...
                                                        <div class="input-group">
                                                            <a class="list-icons-item text-primary"
                                                                href="{{ route("bar_pos_client.edit", $row->id)}}"><i
                                                                    class="icon-pencil7"></i>
                                                            </a>
                                                        </div>&nbsp
                                                        <div class="input-group">
                                                            {!! Form::open(['route' => ['bar_pos_client.destroy',$row->id], 'method' => 'delete']) !!}
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::model($id, array('route' => array('bar_pos_client.update', $id), 'method' => 'PUT')) }}
                                                @else
                                                {{ Form::open(['route' => 'bar_pos_client.store']) }}
                                                @method('POST')
                                                @endif
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label>Phone</label>
                                                        <input type="text" name="phone" value="{{ isset($data) ? $data->phone : ''}}" class="form-control" placeholder="+255713000000" required>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>Email</label>
                                                        <input type="email" name="email" value="{{ isset($data) ? $data->email : ''}}" class="form-control" required>
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label>TIN</label>
                                                        <input type="text" name="TIN" value="{{ isset($data) ? $data->TIN : ''}}" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-6">
                                                        <label>VRN</label>
                                                        <input type="text" name="VRN" value="{{ isset($data) ? $data->VRN : ''}}" class="form-control">
                                                    </div>

                                                    <div class="form-group col-md-6">
                                                        <label>Address</label>
                                                        <textarea name="address" class="form-control" rows="1" required>{{ isset($data) ? $data->address : ''}}</textarea>
                                                    </div>
                                                </div>
