                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{ route('bar_purchase.show',$invoice->id)}}">{{ $invoice->reference_no}}
                                            </a></td>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12 ">
                                ...
                                @if(isset($id))
                                  {{ Form::model($id, ['route' => ['bar_purchase_payment.update', $id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                                @else
                                  {{ Form::open(['route' => 'bar_purchase_payment.store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) }}
                                @endif
