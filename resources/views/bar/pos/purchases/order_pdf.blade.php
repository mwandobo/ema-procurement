...
<div class="head-title">
    <h1 class="text-center m-0 p-0"> Purchase Request</h1>
</div>
        ...
        <tbody>
            ...
            <tr align="center">
                ...
                <?php
                    ...
                    $code = App\Models\Bar\POS\Items::find($row->item_name)?->item_code ?? '';
                ?>

                <td class=""><strong class="block">{{ $code ? "($code) - " : '' }}{{ $item_name }}</strong></td>         
