<div class="modal-content">
    ...
    <br><input type="hidden" name="checked_total_tax[]" value="{{ isset($tax) ? $tax  : '' }}" class="form-control item_total_taxlst{{$order}}" placeholder ="tax" required  jAutoCalc="{checked_quantity} * {checked_price} * {checked_tax_rate}"/>
    <input type="hidden" name="checked_unit[]" value="{{ isset($unit) ? $unit : '' }}" class="form-control item_unitlst{{$order}}" placeholder ="unit" required />
    ...
    <input type="hidden" name="saved_items_id[]" value="{{ isset($saved) ? $saved : '' }}" class="form-control item_savedlst{{$order}}" placeholder ="total" required />
     ...
     <input type="hidden" id="type_id"  class="form-control type_idlst{{$order}}" value="" />
