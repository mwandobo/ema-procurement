                                                        ...
                                                        <table class="table table-bordered" id="cart">
                                                            ...
                                                            <tfoot>
                                                                ...
                                                                <tr class="line_items">
                                                                    ...
                                                                    <td><input type="number" name="price[]" class="form-control item_price{{$i->order_no}}_edit"   value="{{ isset($i) ? $i->price : ''}}"  placeholder ="price" required  value=""/> </td>                                                                 
                                                                     <input type="hidden" name="tax_rate[]"
                                                                            class="form-control item_tax{{$i->order_no}}"
                                                          ...
                                                          <input type="hidden" name="items_id[]"
                                                                    ...
                                                                    <input type="hidden" name="saved_items_id[]"
                                                                        class="form-control name_list"
                                                                        value="{{ isset($i) ? $i->id : ''}}" />
                                                                       <input type="hidden" id="item_id"  class="form-control item_id{{$i->order_no}}" value="{{$i->item_name}}" />
                                                                      <input type="hidden" id="type_id"  class="form-control type_id{{$i->order_no}}" value="{{$i->type}}" />                                   
...
$(document).ready(function() {
 $(document).on('change', '.item_name', function() {
            ...
            '"><option value="">Select Item Name</option>@foreach($name as $n) <option value="{{ $n->id}}">{{$n->name}}</option>@endforeach</select></td>';
                    ...
                    html += '<td><input type="number" name="price[]" class="form-control item_price' +
                        count + '" placeholder ="fee" required  value=""/><div class=""></td>';
                    html += '<input name="tax_rate[]" class="form-control item_tax' + count +
                        '" required type="hidden" value="0">';
                    html +=
          ...
          var type= $('.user_type').val();
           ...
           console.log(id);
            ...
            function model(id, type) {
                ...
                let url = '{{ route("facility_sales.show", ":id") }}';
