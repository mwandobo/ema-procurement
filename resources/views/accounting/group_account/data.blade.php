                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 106.484px;">Group ID</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                            ...
                                                            <a class="list-icons-item text-primary" title="Edit"
                                                                ...
                                                                href="{{ route("group_account.edit", $row->id)}}"><i class="icon-pencil7"></i>
                                                                    </a>
 
                                                            {!! Form::open(['route' =>
                                                            ['group_account.destroy',$row->id], 'method' => 'delete'])
                                                            !!}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="form-group row"><label
                                                    ...
                                                    <div class="col-lg-8">
                                                        <select class="form-control m-b" name="class" required>
                                                            <option value="">Select Class </option>
                                                            @foreach ($class_account as $class)
                                                            <option value="{{$class->class_name}}"
                                                                @if(isset($data))@if($data->class == $class->class_name)
                                                                selected @endif @endif >{{$class->class_name}}</option>
                                                            @endforeach
