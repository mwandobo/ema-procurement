                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 106.484px;">Class ID</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                ...
                                                <td>
                                                    <div class="form-inline">
                                                            ...
                                                            <a class="list-icons-item text-primary" title="Edit"
                                                                ...
                                                                href="{{ route("class_account.edit", $row->id)}}"><i class="icon-pencil7"></i>
                                                                    </a>
 
                                                            {!! Form::open(['route' =>
                                                            ['class_account.destroy',$row->id], 'method' => 'delete'])
                                                            !!}
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-8">
                                                        <input type="text" name="class_name" required placeholder=""
                                                            value="{{ isset($data) ? $data->class_name : ''}}"
                                                            class="form-control">
                                                    </div>
                                                </div>

                                                <div class="form-group row"><label class="col-lg-2 col-form-label">Class
                                                        Type</label>
                                                    ...
                                                    <div class="col-lg-8">
                                                        ...
                                                        <option value="Assets" @if(isset($data))@if($data->
                                                            class_type == 'Assets') selected @endif @endif >Assets
                                                        </option>
                                                        <option value="Liability" @if(isset($data))@if($data->
                                                            class_type == 'Liability') selected @endif
                                                            @endif>Liability</option>
                                                            <option value="Equity" @if(isset($data))@if($data->
                                                                class_type == 'Equity') selected @endif @endif >Equity
                                                            </option>
                                                            <option value="Expense" @if(isset($data))@if($data->
                                                                class_type == 'Expense') selected @endif @endif >Expense
                                                            <option value="Income" @if(isset($data))@if($data->
                                                                class_type == 'Income') selected @endif @endif>Income
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
