...
<!-- Download PDF Button -->
<a href="{{ url('financial_report/income_statement/pdf?start_date=' . request('start_date') . '&end_date=' . request('second_date')) }}" class="btn btn-primary" target="_blank">Download PDF</a>
            
<!-- Download Excel Button -->
<a href="{{ url('financial_report/income_statement/excel?start_date=' . request('start_date') . '&end_date=' . request('second_date')) }}" class="btn btn-warning" target="_blank">Download Excel</a>
...
<td><a href="#view{{$account_code->account_id}}" data-toggle="modal"">{{$account_code->account_codes }}</a>
 ...
 <?php
                        ...
                        //   $cr = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('branch_id',
                        //     session('branch_id'))->sum('credit');
                        // $dr = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('branch_id',
                        //     session('branch_id'))->sum('debit');
                            
                        //   $cr1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('branch_id',
                        //     session('branch_id'))->sum('credit');
                        // $dr1 = \App\Models\Accounting\JournalEntry::where('account_id', $account_code->account_id)->where('branch_id',
                        //     session('branch_id'))->sum('debit');
