                    ...
                    <div class="row">
                        ...
                        <div class="card">
                            ...
                            if (!empty($award_info)): foreach ($award_info as $v_award_info) :
                                ...
                                <input type="hidden"
                                   value="{{ isset($check_salary_payment) ? $check_salary_payment->payment_amount : ''}}"
                                    id="amount">

                                <div class="">
                                    <label class="control-label"><strong>Payment Amount </strong></label>
                                    <input type="text" disabled="" value="{{ isset($check_salary_payment) ? $check_salary_payment->payment_amount : ''}}"
