                    ...
                    <thead>
                        <tr>
                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 186.484px;">Employee</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 186.484px;">Salary Grade</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 136.484px;">Allowance</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    style="width: 258.1094px;"><input type="checkbox" name="select_all"  id="example-select-all"> Select All</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                         ...
                         $fine =$salary_info->fine_deduction;
                          ...
                          $award=$total_award;
                                  $fine =0;
                                        ...
                                        echo   number_format($total_allowance + $overtime + $award,2) ;; //sehemu ya kuonyesha net salary
                                    }
                                   
                                    ?></td>

                              <td>{{ number_format($basic_salary + $total_allowance + $overtime + $award - $total_deduction - $ad - $l-$fine,2) }}</td>
                            <td>
