                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Engine version: activate to sort column ascending"
                                                    style="width: 141.219px;">Resposible Person</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="gradeA even" role="row">
                                                ...
                                                <td>
                                                  ...
                                                  @endphp
                                                     @foreach($tr as $t)
                                                     <a href="#view{{$row->facility}}" data-toggle="modal">{{$t->name}}</a>
                                                    @endforeach
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    @php    
                                                    $st=App\Models\Inventory\FieldStaff::where('id', $row->mechanical)->get();   
                                                  @endphp
                                                     @foreach($st as $s)
                                                    {{$s->name}}
                                                    @endforeach
...
<thead>
               ...
               <?php
                        ...
                        $history = \App\Models\Logistic\Service::where('facility', $row->facility)->get();                                               
?>
...
<thead>
               ...
               <?php
                        ...
                        $minor = \App\Models\Logistic\ServiceItem::where('service_id', $row->id)->get();                                               
?>
