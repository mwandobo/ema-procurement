                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeA even" role="row">
                                                                ...
                                                                <td>
                                                                    ...
                                                                    @php
                                                                    $tr=
                                                                    App\Models\Logistic\Truck::where('id',$row->truck)->get();
                                                                    @endphp
                                                                    @foreach($tr as $t)
                                                                    {{$t->truck_name}}
                                                                    @endforeach
