                            ...
                            <div class="tab-pane fade @if(!empty($id)) active show @endif" id="profile2" role="tabpanel"
                                ...
                                <div class="card">
                                    ...
                                    <div class="form-group row"><label
                                         ...
                                         <option value="Others" @if(isset($data))@if($data->type == 'Others') selected @endif @endif >Others</option>
                                                ...
                                                <div class="form-group row">                                                
                                                    <label class="col-lg-2 col-form-label">Stock Account</label>
                                                    <div class="col-lg-10">
                                                            <select class="form-control m-b" name="stock_id" required
                                                                id="stock_id">
                                                  ...
                                                  <div class="form-group row">                                                
                                                    <label class="col-lg-2 col-form-label">Cost Account</label>
                                                    <div class="col-lg-10">
                                                            <select class="form-control m-b" name="cost_id" required
                                                                id="cost_id">
                                                                <option value="">Select Cost Account</option>
                                                               @foreach($group as $grp)
                                                                  @php  $cost=App\Models\Accounting\AccountCodes::where('account_group',$grp->name)->get() ; @endphp
                                                                @if(!empty($cost))
                                                                @foreach($cost as $row)

                                                                <option @if(isset($data))
                                                                    {{  $data->cost_id == $row->id  ? 'selected' : ''}}
                                                                    @endif value="{{ $row->id}}">{{$row->account_name}}</option>
