...
-->                            </li>
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                           ...
                           @if($row->approval_1 != '' && $row->approval_2 == '')
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('purchase.second_approval', $row->id)}}">First Approval</a>
                          ...
                          @endif
                                @endcan
                                            ...
                                            @if( $row->good_receive == 1)
                                                <a class="nav-link" id="profile-tab2"
                                                                    href="{{ route('issue_pdfview',['download'=>'pdf','id'=>$row->id]) }}"
                                                                    role="tab"
