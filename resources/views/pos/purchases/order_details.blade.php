        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
               ...
               @can('manage-first-approval')
                         ...
                         <a  class="btn btn-xs btn-info"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('purchase.first_approval', $purchases->id)}}">First Approval</a>
                                                           @endif
                                                                @endcan
{{--
...
<a  class="btn btn-xs btn-info"  title="Collect" onclick="return confirm('Are you sure? you want to confirm')" href="{{ route('purchase.confirm_order', $purchases->id)}}">Confirm Order</a>
 @endif
