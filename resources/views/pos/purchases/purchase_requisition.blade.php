                                        ...
                                        <table class="table datatable-basic table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 136.484px;">Purchase Date
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    ...
                                                    <tr class="gradeA even" role="row">
                                                        ...
                                                        <td>
                                                            @if($row->approval_1 == '' && $row->status == 0)
                                                                <div class="badge badge-danger badge-shadow">Waiting For
                                                                    First Approval
                                                                </div>
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        @can('manage-first-approval')
                                                                            @if($row->approval_1 == '' && $row->status == 0)
                                                                                <a class="nav-link" title="Collect"
                                                                                   ...
                                                                                   href="{{ route('purchase.first_approval', $row->id)}}">First
                                                                                    Approval</a>
                                                                            @endif
                                                                        @endcan
                                                                        ...
                                                                        @can('manage-second-approval')
                                                                            @if($row->approval_1 != '' && $row->approval_2 == '' && $row->status == 0)
                                                                                <a class="nav-link" title="Collect"
                                                                                   onclick="return confirm('Are you sure? you want to approve')"
                                                                                   href="{{ route('purchase.second_approval', $row->id)}}">Second
                                                                                    Approval</a>
                                                                                <a class="nav-link" title="Collect"
                                                                                   onclick="return confirm('Are you sure? you want to disapprove')"
                                                                                   href="{{ route('purchase.second_disapproval', $row->id)}}">Disapprove</a>
                                                                            @endif
                                                                        @endcan
                                                                        ...
                                                                        @can('manage-third-approval')
                                                                            @if($row->approval_1 != '' && $row->approval_2 != '' && $row->approval_3 == '')
                                                                                <a class="nav-link" title="Collect"
                                                                                   onclick="return confirm('Are you sure? you want to approve')"
                                                                                   href="{{ route('purchase.final_approval', $row->id)}}">Final
                                                                                    Approval</a>
                                                                                <a class="nav-link" title="Collect"
                                                                                   onclick="return confirm('Are you sure? you want to disapprove')"
                                                                                   href="{{ route('purchase.final_disapproval', $row->id)}}">Disapprove</a>
                                                                            @endif
                                                                        @endcan
                                                                ...
                                                                @if(!empty($items))
                                                                    ...
                                                                    as $n)
                                                                            ...
                                                                            <td><select name="tax_rate[]"
                                                                                        ...
                                                                                        required>
                                                                                    <option value="0">Select Tax Rate
                                                                                    </option>
                                                            ...
                                                            <tr class="line_items">
                                                                ...
                                                                @else
                                                                    ...
                                                                    <td><input type="text" name="amount[]"
                                                                               class="form-control item_total"
                                                                               placeholder="total"
                                                                               required jAutoCalc="{subtotal} + {tax}"
                                                                               readonly>
                                                                    </td>
                                                                @endif
                                                            </tr>
