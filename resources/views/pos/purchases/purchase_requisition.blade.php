   ...
   @endif
                                                <div class="dropdown">
							                		<a href="#" class="list-icons-item dropdown-toggle text-teal" data-toggle="dropdown"><i class="icon-cog6"></i></a>
                                                            ...
                                                            @if($row->approval_1 == '' && $row->status == 0)
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('purchase.first_approval', $row->id)}}">First Approval</a>
                                                           @endif
                                                                @endcan

                                                     @can('manage-second-approval')
                           @if($row->approval_1 != '' && $row->approval_2 == '' && $row->status == 0)
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('purchase.second_approval', $row->id)}}">Second Approval</a>
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to disapprove')" href="{{ route('purchase.second_disapproval', $row->id)}}">Disapprove</a>
                                         @endif
                                               @endcan

                                            @can('manage-third-approval')
                            @if($row->approval_1 != '' && $row->approval_2 != '' && $row->approval_3 == '')
                            <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to approve')" href="{{ route('purchase.final_approval', $row->id)}}">Final Approval</a>
                         <a  class="nav-link"  title="Collect" onclick="return confirm('Are you sure? you want to disapprove')" href="{{ route('purchase.final_disapproval', $row->id)}}">Disapprove</a>
                          @endif
                                @endcan
