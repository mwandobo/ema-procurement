...
<body>
    ...
    <div class="row" style="width:645px;heigth:470px;padding-left:170px;padding-top:38px; border-radius:7px; ">
        <div class="col-md-4" style=" padding-left:4px; background-color: #191970;">
            <img src="{{ url('assets/img/image1.png') }}" class="navbar-logo" alt="logo"
        ...
        <div class="col-md-6"
            style="background-color: #191970; background-image:url({{url('assets/img/logo/image2.png')}});">
            <div class="row" style="">
            ...
            <div class="row" style="margin-top: -0.2em;">
                ...
                <h4 style="color:white;font-size:15px; font-weight: bolder;"><b>{{$member->full_name}}
                    </b></h4>
        ...
        <div class="col-md-2" style="padding-left: 0px;background-color: #008000; height: 290px;">
            <centre>
                <h3
                    style="writing-mode: vertical-lr;  color:white; font-size:{{$font}}px; font-weight: bolder; padding-top:30px;">
