                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col">
                                        ...
                                        <input type="number" name="delivery_charge" class="form-control form-control-sm @error('delivery_charge') is-invalid @enderror" value="{{ old('delivery_charge', $restaurant->delivery_charge) }}">
