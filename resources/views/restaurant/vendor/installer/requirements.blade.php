...
@section('container')
    ...
    @foreach($requirements['requirements'] as $type => $requirement)
        <ul class="list">
            ...
            <li class="list__item {{ extension_loaded('ionCube Loader') ? 'success' : 'error' }}">
                {{ __('ionCube Loader') }}
                <i class="fa fa-fw fa-{{ extension_loaded('ionCube Loader') ? 'check-circle-o' : 'exclamation-circle' }} row-icon" aria-hidden="true"></i>
            </li>
    ...
    @if ( ! isset($requirements['errors']) && $phpSupportInfo['supported'] && extension_loaded('ionCube Loader') )
        <div class="buttons">
