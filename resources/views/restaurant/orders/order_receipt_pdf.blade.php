...
<body>
    ...
    } elseif ($invoices->user_type == 'Member') {
    ...
    <div>
        ...
        <h4 align="center" style="margin-top: 0%;" class="fontS">DAR ES SALAAM GYMKHANA CLUB<h4>
                ...
                <p align="center" style="font-weight: normal;" class="fontL"><b>RECEIPT NO:
                        {{ $invoices->reference_no }}</b>
                    <br><b>Date: {{ Carbon\Carbon::parse($invoices->invoice_date)->format('d/m/Y') }}</b>
                    <br><b>Name: {{ $name }} @if (!empty($invoices->user_type == 'Member'))
                            , {{ $user->member_id }}
                        @endif
                    </b>
                ...
                <table style=" border: none !important; family:source_sans_proregular; font-size:10px;">
                        ...
                        @if (!empty($invoice_items))
                            @foreach ($invoice_items as $row)
                                ...
                                <tr>
                                    ...
                                    <td align="">{{ $row->due_quantity }}</td>
                                    <td align="">{{ number_format($row->total_cost , 2) }}
                                        {{ $invoices->exchange_code }}</td>
                                </tr>
                            @endforeach
                        @endif
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td align="" style="font-weight:bold;">{{ number_format($gland_total, 2) }}
                                {{ $invoices->exchange_code }}</td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td align="" style="font-weight:bold;">{{ number_format($balance, 2) }}
                        </tr>
                ...
                <div class="space  fontS">
                    <div class="col-md-12">
                        <p class="fontL"><b>Receiving Officer:&nbsp;&nbsp;&nbsp;{{ auth()->user()->name }}</b></p>
                        <p class="fontL"><b>Signature:&nbsp;&nbsp;&nbsp;___________</b></p>
