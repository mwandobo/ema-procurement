...
<div class="layout-px-spacing">
    <div class="row layout-top-spacing">
                ...
                <div class="f-100">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="media">
                                <div class="mr-3">
                                    <img src="../../../../assets/img/logo/{{!empty($data->picture)? $data->picture : '' }}"
                                ...
                                <div class="align-self-center media-body">
                                    <div class="text-muted">
                                        ...
                                        @if($data->status == 1)
                                        <p class="mb-0"> Membership Status<span class="mb-0 badge badge-danger"> Not
                                                Active</span></p>

                                        @else
                                        <p class="mb-0 badge badge-sucsess"> Active</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="align-self-center col-lg-5">
                            <div class="text-lg-center mt-4 mt-lg-0">
                                <div class="row">
                                    <div class="col-3">
                                        <div>
                                            <p class="text-muted text-truncate mb-2">Football Grounds</p>
                                            <h5 class="mb-0"> {{ __('1') }}</h5>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div>
                                            <p class="text-muted text-truncate mb-2"> Volleybal Grounds</p>
                                            <h5 class="mb-0"> {{ __('2') }}</h5>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div>
                                            <p class="text-muted text-truncate mb-2"> Tenis Grounds</p>
                                            <h5 class="mb-0"> {{ __('3') }}</h5>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div>
                                            <p class="text-muted text-truncate mb-2"> Clickets Grounds</p>
                                            <h5 class="mb-0"> {{ __('4') }}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="offset-md-4">
            <marquee>
                <p class="mb-1 badge badge-danger"> Please Make Payment To complete Your Application</p>
            </marquee>
        </div>
        @endif
        <!-- 4 COLUMNS -->
                            ...
                            <div class="card-footer d-sm-flex justify-content-sm-between align-items-sm-center">
                                ...
                                <ul class="list-inline list-inline-condensed mb-0 mt-2 mt-sm-0">
                                    <li class="list-inline-item">
                                        <a href="{{route('member_payments.show',$row->id)}}" class="text-body badge badge-success"><i
                                                class="icon-eye8"></i>clickhere to pay your invoice</a>
                                    </li>
