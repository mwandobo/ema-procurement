                                                    ...
                                                    <table id="basic-dt" class="table datatable-basic table-striped"" style="width:100%">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="gradeA even" role="row">
                                                                ...
                                                                <td>{{$row->membership_types->name}}  {{ isset($row->membership_types->class) ?  '- '. $row->membership_types->class : ''}}</td>
                                                                <td>{{number_format($row->development_fee,2)}}</td>
                                                                <td>{{number_format($row->subscription_fee,2)}}</td>
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <select class="form-control m-b"
                                                                            ...
                                                                            <option @if(isset($data))
                                                                                ...
                                                                                @endif value="{{ $row->id}}">
                                                                                {{$row->name}} {{ isset($row->class) ?  '- '. $row->class : ''}}</option>
