                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 300.484px;">Invoice No</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    ...
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 250.484px;">Due Amount</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0"
                                                    rowspan="1" colspan="1"
                                                    aria-label="Platform(s): activate to sort column ascending"
                                                    style="width: 250.484px;">Status</th>
                            ...
                            <div class="tab-pane fade @if(!empty($id)) active show @endif" id="profile2" role="tabpanel"
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        @endif
                                        <hr>
                                        <p><h4><b>Bank Details</b></h4></p>
                                        <p><h4><b>Account Bumber :</b>23333494843993</h4></p>
                                        <p><h4><b>Bank Name ::</b> CRDB Bank   </h4></p>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12 ">
                                                @if(isset($id))
                                                {{ Form::open(['route' => 'member_payments.store','enctype'=>'multipart/form-data']) }}
                                                @method('POST')
                                                @else
                                                {{ Form::open(['route' => 'member_payments.store','enctype'=>'multipart/form-data']) }}
                                                @method('POST')
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-lg-2 col-form-label">Enter Bank Slip(pdf)</label>
                                                    <div class="col-lg-8">
